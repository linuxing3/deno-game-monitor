...
export class AccountsSettings extends Model {
  static table = "accountsSettingss";
  ...
  static meta = {
    ...
    fieldProperty: [
      ...
      },
      {
        ...
        type: "select",
        placeholder:
          "Input Role Allowed To Set Frozen Accounts Edit Frozen Entries",
        options: "",
      },
      {
      ...
      },
      {
        ...
        type: "input",
        placeholder:
          "Input Allow Cost Center In Entry Of Balance Sheet Account",
        options: "",
      },
      {
        ...
        type: "input",
        placeholder:
          "Input Automatically Add Taxes And Charges From Item Tax Template",
        options: "",
      },
      {
        key: "printSettings",
