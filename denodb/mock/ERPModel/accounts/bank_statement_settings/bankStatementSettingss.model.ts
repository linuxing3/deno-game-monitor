...
|--------------------------------------------------------------------------
|
| Model Class and Interface of bankStatementSettingss
|
*/
import {
  DataTypes,
...
export class BankStatementSettings extends Model { 
  static table = "bankStatementSettingss";
...
export interface IBankStatementSettings {
  id: FieldValue;
  bankAccount: FieldValue;
  dateFormat: FieldValue;
  statementHeaderMapping: FieldValue;
  statementHeaders: FieldValue;
  transactionDataMapping: FieldValue;
  mappedItems: FieldValue;
