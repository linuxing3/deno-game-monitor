...
export interface IPurchaseInvoice {
  ...
  dueDate: FieldValue;
  isPaid: FieldValue;
  isReturnDebitNote: FieldValue;
  applyTaxWithholdingAmount: FieldValue;
  company: FieldValue;
  ...
  holdInvoice: FieldValue;
  releaseDate: FieldValue;
  reasonForPuttingOnHold: FieldValue;
  supplierInvoiceDetails: FieldValue;
  supplierInvoiceNo: FieldValue;
  supplierInvoiceDate: FieldValue;
  returns: FieldValue;
  returnAgainstPurchaseInvoice: FieldValue;
  addressAndContact: FieldValue;
  selectSupplierAddress: FieldValue;
  address: FieldValue;
  contactPerson: FieldValue;
  contact: FieldValue;
  mobileNo: FieldValue;
  contactEmail: FieldValue;
  selectShippingAddress: FieldValue;
  ...
  setAcceptedWarehouse: FieldValue;
  rejectedWarehouse: FieldValue;
  supplierWarehouse: FieldValue;
  updateStock: FieldValue;
  scanBarcode: FieldValue;
  items: FieldValue;
  rawMaterialsSupplied: FieldValue;
  suppliedItems: FieldValue;
  ...
  purchaseTaxesAndChargesTemplate: FieldValue;
  purchaseTaxesAndCharges: FieldValue;
  taxBreakup: FieldValue;
  taxesAndChargesCalculation: FieldValue;
  taxesAndChargesAddedCompanyCurrency: FieldValue;
  taxesAndChargesDeductedCompanyCurrency: FieldValue;
  totalTaxesAndChargesCompanyCurrency: FieldValue;
  taxesAndChargesAdded: FieldValue;
  taxesAndChargesDeducted: FieldValue;
  ...
  disableRoundedTotal: FieldValue;
  payments: FieldValue;
  ...
  setAdvancesAndAllocateFifo: FieldValue;
  getAdvancesPaid: FieldValue;
  advances: FieldValue;
  ...
  terms: FieldValue;
  termsAndConditions1: FieldValue;
  ...
  againstExpenseAccount: FieldValue;
  status: FieldValue;
