...
export interface ISalesInvoice {
  ...
  taxId: FieldValue;
  project: FieldValue;
  includePaymentPos: FieldValue;
  posProfile: FieldValue;
  offlinePosName: FieldValue;
  isReturnCreditNote: FieldValue;
  company: FieldValue;
  costCenter: FieldValue;
  date: FieldValue;
  postingTime: FieldValue;
  editPostingDateAndTime: FieldValue;
  paymentDueDate: FieldValue;
  amendedFrom: FieldValue;
  returns: FieldValue;
  returnAgainstSalesInvoice: FieldValue;
  updateBilledAmountInSalesOrder: FieldValue;
  customerPoDetails: FieldValue;
  customerSPurchaseOrder: FieldValue;
  customerSPurchaseOrderDate: FieldValue;
  addressAndContact: FieldValue;
  customerAddress: FieldValue;
  address: FieldValue;
  ...
  shippingAddressName: FieldValue;
  shippingAddress: FieldValue;
  companyAddressName: FieldValue;
  companyAddress: FieldValue;
  currencyAndPriceList: FieldValue;
  currency: FieldValue;
  exchangeRate: FieldValue;
  priceList: FieldValue;
  priceListCurrency: FieldValue;
  priceListExchangeRate: FieldValue;
  ignorePricingRule: FieldValue;
  setSourceWarehouse: FieldValue;
  updateStock: FieldValue;
  scanBarcode: FieldValue;
  items: FieldValue;
  packingList: FieldValue;
  packedItems: FieldValue;
  productBundleHelp: FieldValue;
  timeSheetList: FieldValue;
  timeSheets: FieldValue;
  totalBillingAmount: FieldValue;
  totalQuantity: FieldValue;
  totalCompanyCurrency: FieldValue;
  netTotalCompanyCurrency: FieldValue;
  total: FieldValue;
  netTotal: FieldValue;
  totalNetWeight: FieldValue;
  taxCategory: FieldValue;
  shippingRule: FieldValue;
  salesTaxesAndChargesTemplate: FieldValue;
  salesTaxesAndCharges: FieldValue;
  taxBreakup: FieldValue;
  taxesAndChargesCalculation: FieldValue;
  totalTaxesAndChargesCompanyCurrency: FieldValue;
  totalTaxesAndCharges: FieldValue;
  loyaltyPointsRedemption: FieldValue;
  loyaltyPoints: FieldValue;
  loyaltyAmount: FieldValue;
  redeemLoyaltyPoints: FieldValue;
  loyaltyProgram: FieldValue;
  redemptionAccount: FieldValue;
  redemptionCostCenter: FieldValue;
  additionalDiscount: FieldValue;
  applyAdditionalDiscountOn: FieldValue;
  additionalDiscountAmountCompanyCurrency: FieldValue;
  additionalDiscountPercentage: FieldValue;
  additionalDiscountAmount: FieldValue;
  grandTotalCompanyCurrency: FieldValue;
  roundingAdjustmentCompanyCurrency: FieldValue;
  roundedTotalCompanyCurrency: FieldValue;
  inWordsCompanyCurrency: FieldValue;
  grandTotal: FieldValue;
  roundingAdjustment: FieldValue;
  roundedTotal: FieldValue;
  inWords: FieldValue;
  totalAdvance: FieldValue;
  outstandingAmount: FieldValue;
  advancePayments: FieldValue;
  allocateAdvancesAutomaticallyFifo: FieldValue;
  getAdvancesReceived: FieldValue;
  advances: FieldValue;
  paymentTerms: FieldValue;
  paymentTermsTemplate: FieldValue;
  paymentSchedule: FieldValue;
  payments: FieldValue;
  cashBankAccount: FieldValue;
  salesInvoicePayment: FieldValue;
  paidAmountCompanyCurrency: FieldValue;
  paidAmount: FieldValue;
  baseChangeAmountCompanyCurrency: FieldValue;
  changeAmount: FieldValue;
  accountForChangeAmount: FieldValue;
  writeOff: FieldValue;
  writeOffAmount: FieldValue;
  writeOffAmountCompanyCurrency: FieldValue;
  writeOffOutstandingAmount: FieldValue;
  writeOffAccount: FieldValue;
  writeOffCostCenter: FieldValue;
  terms: FieldValue;
  termsAndConditionsDetails: FieldValue;
  printingSettings: FieldValue;
  letterHead: FieldValue;
  groupSameItems: FieldValue;
  printLanguage: FieldValue;
  printHeading: FieldValue;
  moreInformation: FieldValue;
  interCompanyInvoiceReference: FieldValue;
  ...
  debitTo: FieldValue;
  partyAccountCurrency: FieldValue;
  isOpeningEntry: FieldValue;
  cFormApplicable: FieldValue;
  cFormNo: FieldValue;
  remarks: FieldValue;
  commission: FieldValue;
  salesPartner: FieldValue;
  commissionRate: FieldValue;
  totalCommission: FieldValue;
  salesTeam: FieldValue;
  salesTeam1: FieldValue;
  subscriptionSection: FieldValue;
  fromDate: FieldValue;
  toDate: FieldValue;
  autoRepeat: FieldValue;
  updateAutoRepeatReference: FieldValue;
  againstIncomeAccount: FieldValue;
  totalQty: FieldValue;
