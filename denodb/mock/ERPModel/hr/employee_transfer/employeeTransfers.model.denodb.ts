...
export interface IEmployeeTransfer {
  ...
  transferDate: FieldValue;
  company: FieldValue;
  newCompany: FieldValue;
  department: FieldValue;
  employeeTransferDetails: FieldValue;
  employeeTransferDetail: FieldValue;
  reAllocateLeaves: FieldValue;
  createNewEmployeeId: FieldValue;
  newEmployeeId: FieldValue;
